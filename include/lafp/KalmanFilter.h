...
/* KalmanFilter.h is the v1 Kalman filter using the legacy 'marray' type.
 * It is preserved for historical reference but is NOT compiled into liblafp.
 * The v2 equivalent (KalmanFilter2.h / KalmanFilter2.c) should be used instead.
 */
