...
#include <lafp/NGPtools2.h>
#include <lafp/NGPsample2.h>
#include <lafp/mdarray.h>
#include <lafp/matrix_utils.h>
#include <lafp/mvnorm.h>

/* Compat shim: GM_FreeGSLMarray was part of the old libmarray API.
 * It is equivalent to marray3d_free for the marray3d* pointers freed here. */
static void GM_FreeGSLMarray(void *p) { marray3d_free((marray3d *)p); }
